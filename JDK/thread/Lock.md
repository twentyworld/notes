...
public class ReentrantLockLearn {
    ...
    public static void main(String[] args)  {
        final ReentrantLockLearn learn = new ReentrantLockLearn();

        new Thread(){
            public void run() {
                learn.insert(Thread.currentThread());
            };
        }.start();
...
所以我们只需要把Lock设置为类的属性：
```Java
public class ReentrantLockRightLearn {
    private static ArrayList<Integer> arrayList = new ArrayList<Integer>();
    private Lock lock = new ReentrantLock();    //注意这个地方
    public static void main(String[] args)  {
        final ReentrantLockRightLearn learn = new ReentrantLockRightLearn();
...
public class ReentrantLockTryLockLearn {
    ...
    private Lock lock = new ReentrantLock();    //注意这个地方
    public static void main(String[] args)  {
        final ReentrantLockTryLockLearn learn = new ReentrantLockTryLockLearn();
...
```Java
public class ReentrantLockLockInterruptiblyLearn {
    private Lock lock = new ReentrantLock();
    public static void main(String[] args)  {
        ReentrantLockLockInterruptiblyLearn learn = new ReentrantLockLockInterruptiblyLearn();
        MyThread thread1 = new MyThread(learn);
        MyThread thread2 = new MyThread(learn);
        thread1.start();
        thread2.start();
...
class MyThread extends Thread {
    private ReentrantLockLockInterruptiblyLearn learn = null;
    public MyThread(ReentrantLockLockInterruptiblyLearn learn) {
        this.learn = learn;
    }
    @Override
    public void run() {
